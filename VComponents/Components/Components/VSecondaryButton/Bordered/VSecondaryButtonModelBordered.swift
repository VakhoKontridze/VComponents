//
//  VSecondaryButtonModelBordered.swift
//  VComponents
//
...
// MARK:- V Secondary Button Model Bordered
public struct VSecondaryButtonModelBordered {
...
// MARK:- Layout
extension VSecondaryButtonModelBordered {
...
extension VSecondaryButtonModelBordered.Layout {
...
extension VSecondaryButtonModelBordered.Colors {
    ...
    public struct BorderColors {
        ...
        public init(
            enabled: Color = .clear,//ColorBook.PrimaryButtonBordered.Border.enabled,
            pressed: Color = .clear,//ColorBook.PrimaryButtonBordered.Border.pressed,
            disabled: Color = .clear//ColorBook.PrimaryButtonBordered.Border.disabled
        ) {
            self.enabled = enabled
            self.pressed = pressed
            self.disabled = disabled
