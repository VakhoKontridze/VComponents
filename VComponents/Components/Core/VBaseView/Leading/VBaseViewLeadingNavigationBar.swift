//
//  VBaseViewLeadingNavigationBar.swift
//  VComponents
//
...
// MARK:- Modifier
extension View {
    func setUpBaseViewLeadingNavigationBar<LeadingItem, TrailingItem>(
        model: VBaseViewLeadingModel,
        title: String,
        ...
        where
            ...
            TrailingItem: View
    {
        modifier(VBaseViewLeadingNavigationBar(
            model: model,
            title: title,
            leadingItem: leadingItem,
            trailingItem: trailingItem,
...
// MARK:- V Base View Leading Navigation Bar
struct VBaseViewLeadingNavigationBar<TrailingItem, LeadingItem>: ViewModifier
    where
        LeadingItem: View,
        TrailingItem: View
{
    ...
    private let model: VBaseViewLeadingModel
...
// MARK:- Body
extension VBaseViewLeadingNavigationBar {
