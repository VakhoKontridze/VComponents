...
struct VTextDemoView: View {
    ...
    @State private var textTypeHelper: VTextTypeHelper = .center
...
// MARK: - Helpers
private enum VTextTypeHelper: Int, StringRepresentableHashableEnumeration {
    case center
    case leading
    case trailing
    case multiLineCenter
