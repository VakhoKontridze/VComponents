//
//  VDynamicPagerTabViewAppearance.swift
//  VComponents
//
...
public struct VDynamicPagerTabViewAppearance {
    ...
    // MARK: Types
    /// Tab selection indicator width type.
    nonisolated public enum TabSelectionIndicatorWidthType: Int, Sendable, CaseIterable {
        // MARK: Cases
