    ...
    where Content: View
{
    ...
    private var modalView: some View {
            ...
            contentView
                .apply {
                    ...
                    case .fixed(let dimension):
                        $0
                            .frame(width: dimension.toAbsolute(dimension: modalPresenterContext.containerSize.width))
                ...
                .apply {
                    ...
                    case .fixed(let dimension):
                        $0
                            .frame(height: dimension.toAbsolute(dimension: modalPresenterContext.containerSize.height))
        ...
        .padding(.vertical, currentHeight.margin.toAbsolute(dimension: modalPresenterContext.containerSize.height))
