...
public struct VBottomSheetAppearance {
    ...
    nonisolated public struct Size: Equatable, Sendable {
        /// Width.
    ...
    nonisolated public struct Heights: Equatable, Sendable {
