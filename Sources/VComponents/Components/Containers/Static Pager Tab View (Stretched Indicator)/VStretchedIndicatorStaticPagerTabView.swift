...
/// View that switches between child views, attributed with pager with stretched rectangular indicator.
///
        ...
        Content: View
{
    ...
    private func calculateIndicatorFrame(
        ...
        tabIndicatorWidth =
            ...
            2 * uiModel.tabIndicatorMarginHor
        ...
        tabIndicatorOffset = {
            ...
            if !uiModel.tabIndicatorBounces {
                contentOffset.clamp(
                    min: 0,
            ...
            PreviewContainer(hasLayer: false, content: {
                VStretchedIndicatorStaticPagerTabView(
                    uiModel: {
                        ...
                        uiModel.tabIndicatorMarginHor = 20
                        return uiModel
                    }(),
                    selection: $selection,
                    data: RGBColor.allCases,
