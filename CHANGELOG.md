...
- Minimum `Swift` language version is increased to `6.3`
...
- `Text` and `Image` configurations are overhauled in Appearances, and are now handled via dedicated Configuration objects
